 ...
 */
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/garages', {
        templateUrl: 'views/garages.html',
        controller: 'GaragesCtrl',
        activetab:'garages'
      })
      .when('/contact', {
      ...
      .whenAuthenticated('/account', {
        ...
        .whenAuthenticated('/changepass', {
        templateUrl: 'views/changepass.html',
        controller: 'AccountCtrl',
        activetab: 'account'
      })
        .whenAuthenticated('/vehicles', {
        templateUrl: 'views/vehicles.html',
        controller: '',
        activetab: 'account'
      })
     .whenAuthenticated('/history', {
        templateUrl: 'views/history.html',
        controller: 'HistoryCtrl',
        activetab: 'history'
      })
    .whenAuthenticated('/schedule', {
